...
export class VideoGenerationService extends BaseService {
  ...
  async generateVideo(
    ...
    try {
      ...
      const response = await this.api.post<VideoGenerationResponse>('/api/videos/generate', input);
   ...
   */
  async checkProgress(generationId: string): Promise<ServiceResult<VideoGenerationProgress>> {
    ...
    try {
      ...
      const response = await this.api.get<VideoGenerationProgress>(
        `/api/videos/status/${generationId}`,
      );
   ...
   */
  async getResult(generationId: string): Promise<ServiceResult<VideoGenerationResult>> {
    ...
    try {
      ...
      const response = await this.api.get<VideoGenerationResult>(
        `/api/videos/status/${generationId}/result`,
      );
