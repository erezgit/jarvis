import { apiAdapter as api, isApiError } from '@/lib/api/adapter';
import type { Project, QueryResult } from '@/types/project';
 ...
 */
export async function fetchProjectDetails(projectId: string): Promise<QueryResult<Project>> {
  ...
  try {
    // Remove /api/ prefix as it's handled by the adapter
